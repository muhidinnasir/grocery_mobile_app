...
class AppNavigationScreen extends StatelessWidget {
  ...
  /// Navigates to the onboardingzeroScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the onboardingzeroScreen.
  onTapOnboardingZero(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.onboardingzeroScreen);
  }
  ...
  onTapThankyou(BuildContext context) {
